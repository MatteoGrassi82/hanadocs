...
During conversation, when patient response triggers a branch decision:
1. Patient response parsed and entities extracted
2. Each expert model independently evaluates possible next actions
3. Consensus determines optimal branch within latency budget
4. If no action achieves sufficient consensus, system falls back to safe default
