...
- GPU nodes for reasoning engine inference (can use organization's existing GPU infrastructure)
...
**Hybrid Options:**
- On-premises data processing with cloud-based model updates (no PHI leaves premises)
- Conversation execution on-premises with anonymized analytics sent to cloud for quality monitoring
- Full air-gapped deployment for maximum isolation
